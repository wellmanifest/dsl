...
projection therefore blocks the next integration ticket. `new-project 0.20.3`
...
- Adopted the complete managed `new-project 0.20.3` package at its published
...
- Pinned the adoption-bound Docker base by immutable digest, retired the stale
  reusable governance job, and bound the target-owned CI migration to exact
  base/head digests.
